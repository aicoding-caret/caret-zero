		...
		return (
			<ContentArea>
				<Section>
					...
					<OptionRow>
						<VSCodeTextField placeholder="Enter Mode Name" value={modeName} style={{ width: "100%" }}>
							Mode Name:
						</VSCodeTextField>
					</OptionRow>
					<OptionRow>
					...
					<OptionRow>
						<VSCodeTextField placeholder="/path/to/allowed" style={{ width: "100%" }}>
							Allowed File Paths (comma-separated):
						</VSCodeTextField>
					</OptionRow>
	...
	return (
		<Container>
			...
			<div
				...
				<VSCodeButton appearance="primary" style={{ marginRight: "5px" }}>
