{
	"modes": [
	  ...
	  },
	  {
		"id": "arch",
		"name": "Arch",
		"description": "Architect: Technical strategy & design mode",
		"rules": [
	  ...
	  },
	  {
		"id": "dev",
		"name": "Dev",
		"description": "Developer: Code implementation & debugging mode",
		"rules": [
	  ...
	  },
	  {
		"id": "rule",
		"name": "Rule",
		"description": "AI System Rules Optimization & Prompt Engineering mode",
		"rules": [
	  ...
	  },
	  {
		"id": "mode-5",
		"name": "Custom Mode",
		"description": "Your custom AI assistant mode",
		"rules": [
		  "Add custom rules here",
		  "Each line represents one rule",
		  "Rules define how the AI should behave"
		],
		"model": "",
		"apiProvider": "anthropic",
		"apiKey": ""
