...
interface BedrockOptionsProps {
	...
	setAwsEndpointSelected: (selected: boolean) => void
	selectedModelInfo: any // Using any for simplicity, ideally we would use ModelInfo
			...
			<p
				...
				{apiConfiguration?.awsUseProfile ? (
					...
					<>
						...
						~/.aws/credentials or env variables. These credentials are only used locally to make API requests
						from this extension.
					</>
				)}
			</p>
