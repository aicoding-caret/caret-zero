	...
	const pages = useMemo(() => {
		const result: {
			currentState: {
				...
				consoleLogs?: string
				messages: CaretMessage[] // messages up to and including the result
			}
			nextAction?: {
				messages: CaretMessage[] // messages leading to next result
			}
		}[] = []

		let currentStateMessages: CaretMessage[] = []
		let nextActionMessages: CaretMessage[] = []
