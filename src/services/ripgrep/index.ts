...
export async function regexSearchFiles(
	...
	// Filter results using CaretIgnoreController if provided
	const filteredResults = caretIgnoreController
		? results.filter((result) => caretIgnoreController.validateAccess(result.filePath))
		: results
