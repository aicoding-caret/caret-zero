...
import { getWorkspacePath, validateWorkspacePath, initializeGitRepository, getFileChanges, calculateToolSuccessRate, } from "./GitHelper";
import { updateGlobalState, getAllExtensionState, updateApiConfiguration, storeSecret, updateWorkspaceState, } from "@core/storage/state";
            ...
            try {
                ...
                try {
                    ...
                    if (apiKey) {
                        ...
                        await updateWorkspaceState(visibleWebview.controller.context, "apiProvider", "cline");
