 ...
 */
export function extractCommitMessage(aiResponse) {
...
export async function showCommitMessageOptions(message) {
    ...
    const selectedAction = await vscode.window.showInformationMessage("Commit message generated", { modal: false, detail: message }, copyAction, applyAction, editAction);
