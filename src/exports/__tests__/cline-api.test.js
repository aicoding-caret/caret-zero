...
describe("ClineAPI Core Functionality", () => {
    ...
    beforeEach(() => {
        ...
        // Create API instance
        api = createClineAPI(mockOutputChannel, mockController);
    });
    afterEach(() => {
        sandbox.restore();
    });
    ...
    describe("startNewTask", () => {
        it("should clear existing task and start new one with description", async () => {
            ...
            sinon.assert.calledWith(mockOutputChannel.appendLine, `Task started with message: "Create a test function" and 2 image(s)`);
        });
        ...
        it("should handle task with no images", async () => {
            ...
            sinon.assert.calledWith(mockOutputChannel.appendLine, `Task started with message: "Task without images" and 0 image(s)`);
        });
    });
