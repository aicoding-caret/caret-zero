import { ApiConfiguration as ProtoApiConfiguration, ChatSettings as ProtoChatSettings, PlanActMode, } from "../../../shared/proto/state";
/**
...
export function convertProtoApiConfigurationToApiConfiguration(protoConfig) {
    ...
    const config = {
        // Core API fields
        apiProvider: protoConfig.apiProvider,
        ...
        awsBedrockCustomModelBaseId: protoConfig.awsBedrockCustomModelBaseId,
