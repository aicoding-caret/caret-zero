...
function createBaseChatSettings() {
...
export const AutoApprovalSettingsRequest = {
	...
	fromJSON(object) {
		return {
			...
			favorites: globalThis.Array.isArray(object?.favorites) ? object.favorites.map((e) => globalThis.String(e)) : [],
		}
	},
	toJSON(message) {
		const obj = {}
	...
	fromJSON(object) {
		return {
			...
			vscodeLmModelSelector: isSet(object.vscodeLmModelSelector)
				...
				: undefined,
			openrouterModelInfo: isSet(object.openrouterModelInfo) ? globalThis.String(object.openrouterModelInfo) : undefined,
