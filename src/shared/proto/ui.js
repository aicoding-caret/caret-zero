...
;(function (ClineSay) {
	...
	ClineSay[(ClineSay["USE_MCP_SERVER_SAY"] = 19)] = "USE_MCP_SERVER_SAY"
	ClineSay[(ClineSay["DIFF_ERROR"] = 20)] = "DIFF_ERROR"
	ClineSay[(ClineSay["DELETED_API_REQS"] = 21)] = "DELETED_API_REQS"
	ClineSay[(ClineSay["CLINEIGNORE_ERROR"] = 22)] = "CLINEIGNORE_ERROR"
	ClineSay[(ClineSay["CHECKPOINT_CREATED"] = 23)] = "CHECKPOINT_CREATED"
	ClineSay[(ClineSay["LOAD_MCP_DOCUMENTATION"] = 24)] = "LOAD_MCP_DOCUMENTATION"
	ClineSay[(ClineSay["INFO"] = 25)] = "INFO"
...
export const ClineApiReqInfo = {
	...
	fromJSON(object) {
		return {
			...
			streamingFailedMessage: isSet(object.streamingFailedMessage) ? globalThis.String(object.streamingFailedMessage) : "",
	...
	fromJSON(object) {
		return {
			...
			browserActionResult: isSet(object.browserActionResult)
				...
				: undefined,
			askUseMcpServer: isSet(object.askUseMcpServer) ? ClineAskUseMcpServer.fromJSON(object.askUseMcpServer) : undefined,
	...
	fromPartial(object) {
		...
		message.conversationHistoryDeletedRange =
			object.conversationHistoryDeletedRange !== undefined && object.conversationHistoryDeletedRange !== null
				...
				: undefined
		message.sayTool =
			object.sayTool !== undefined && object.sayTool !== null ? ClineSayTool.fromPartial(object.sayTool) : undefined
