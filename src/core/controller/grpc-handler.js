...
export class GrpcHandler {
     ...
     */
    async handleRequest(service, method, message, requestId, isStreaming = false) {
        try {
...
export async function handleGrpcRequest(controller, request) {
    try {
        ...
        const response = (await grpcHandler.handleRequest(request.service, request.method, request.message, request.request_id, false));
