import { RuleFile } from "@shared/proto/file";
 ...
 */
export const createRuleFile = async (controller, request) => {
    ...
    if (fileExists) {
        ...
        await handleFileServiceRequest(controller, "openFile", { value: filePath });
        vscode.window.showInformationMessage(`Created new ${request.isGlobal ? "global" : "workspace"} ${fileTypeName} file: ${request.filename}`);
    }
