...
import { WebviewProviderType } from "@shared/proto/ui"
import { getRequestRegistry } from "../grpc-handler"
// Track subscriptions with their provider type
const mcpButtonClickedSubscriptions = new Map()
/**
 ...
 */
export async function subscribeToMcpButtonClicked(_controller, request, responseStream, requestId) {
 ...
 */
export async function sendMcpButtonClickedEvent(webviewType) {
